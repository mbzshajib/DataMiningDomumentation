...
\end{center}  
  ...
  \captionof{table}{Frequent Items}
\end{minipage}
\hfill
\begin{minipage}{0.40\textwidth}
  \centering
  \includegraphics[width=\textwidth]{images/frequent_tree.jpg}
  \captionof{figure}{Frequent Item Tree }
\end{minipage}
...
\end{tabular}
\end{center}  
  \captionof{table}{Transaction Table removing infrequent}
\end{minipage}
\hfill
\begin{minipage}{0.50\textwidth}
  \centering
  \includegraphics[width=\textwidth]{images/frequent_tree_final.jpg}
  \captionof{figure}{Frequent Item Tree Updated}		
\end{minipage}
